...
# Unit tests for ForestVPNCloudAPI::Location
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ForestVPNCloudAPI::Location do
  let(:instance) { ForestVPNCloudAPI::Location.new }

  describe 'test an instance of Location' do
    it 'should create an instance of Location' do
      expect(instance).to be_instance_of(ForestVPNCloudAPI::Location)
    end
  end
