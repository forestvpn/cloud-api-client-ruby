...
# Unit tests for ForestVPNCloudAPI::Billing
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ForestVPNCloudAPI::Billing do
  let(:instance) { ForestVPNCloudAPI::Billing.new }

  describe 'test an instance of Billing' do
    it 'should create an instance of Billing' do
      expect(instance).to be_instance_of(ForestVPNCloudAPI::Billing)
    end
  end
